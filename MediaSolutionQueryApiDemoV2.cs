...
{
    class MediaSolutionQueryApiDemoV2
    {
        public static void mediaSolutionQuery()
        {
            /** 产品密钥ID，产品标识 */
            ...
            String apiUrl = "http://as.dun.163.com/v2/mediasolution/callback/query";
            ...
            parameters.Add("taskIds", "['3zrndkgdbexb0h4db91jcubg05009r26']");
