...
{
    class ReportSolutionQueryApiDemo
    {
        public static void reportSolutionQuery()
        {
            /** 产品密钥ID，产品标识 */
            ...
            String apiUrl = "http://as.dun.163.com/v1/report/callback/query";
            ...
            parameters.Add("taskIds", "['stwthwatlqgaal5xjx1rgzjg05009r28']");
