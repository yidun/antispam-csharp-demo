...
{
    class ReportSolutionSubmitApiDemo
    {
        public static void reportSolutionSubmit()
        {     
            /** 产品密钥ID，产品标识 */
            ...
            /** 易盾反垃圾举报解决方案在线检测接口地址  */
            String apiUrl = "http://as.dun.163.com/v1/report/submit";
            ...
            // 2.设置私有参数
            parameters.Add("dataId", "0000");
            parameters.Add("callback", "i am callback");
            parameters.Add("account", "account1");
            parameters.Add("scenarios", "直播涉政");
            parameters.Add("roomId", "room3");
            parameters.Add("reportedId", "user010");
            parameters.Add("reportType", "举报类型");
