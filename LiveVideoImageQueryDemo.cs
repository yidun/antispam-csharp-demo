...
namespace Com.Netease.Is.Antispam.Demo
{
    class LiveVideoImageQueryDemo
    {
        public static void liveVideoQuery()
        {
            ...
            String apiUrl = "http://as.dun.163.com/v1/livevideo/query/image";
            ...
            // 2.设置私有参数
            parameters.Add("taskId", "liz9lagl8ymv3tj0h3537l8g00409r6s");
            parameters.Add("pageNum", "1");
            parameters.Add("pageSize", "10");
            parameters.Add("levels", "[0,1,2]");
            parameters.Add("callbackStatus", "1"); // 详情查看官网CallbackStatus
            parameters.Add("orderType", "3"); // 详情查看官网LiveVideoOrderType
                    ...
                    if(null == result){
                        ...
                        if(status == 0){
                            foreach (var item in rows){
                                ...
                                int callbackStatus = null == row["callbackStatus"] ? 0 : row.GetValue("callbackStatus").ToObject<Int32>();
                                ...
                                Console.WriteLine(String.Format("url={0}, label={1}, labelLevel={2}, callbackStatus={3} [beginTime={4} -- endTime={5}], ", url, label, labelLevel, callbackStatus, beginTime, endTime));
                            }
