...
{
    class LiveVideoSolutionQueryByTaskIdsDemo
    {
        public static void liveVideoQuery()
        {
            ...
            String apiUrl = "http://as.dun.163yun.com/v1/livewallsolution/query/task";
            ...
            jarray.Add("95b9496929a647d3be6bee74db639eab");
            jarray.Add("08c71667adff49b4bc916a2e2114081a");
                ...
                if (code == 200)
                {
                    ...
                    if(null == array){
                        ...
                        foreach (var item in array)
                        {
                            ...
                            Console.WriteLine(String.Format("taskId={0}, status={1}", code, msg));
                            if(null != tmp["callbackStatus"]){
                                int callbackStatus = tmp.GetValue("callbackStatus").ToObject<int>();
                                Console.WriteLine(String.Format("callbackStatus={0}", callbackStatus));
                            }
                        }
                    }
                }
