...
{
    class LiveAudioFeedbackApiDemo
    {
        public static void audioFeedback()
        {     
            /** 产品密钥ID，产品标识 */
            ...
            /** 易盾反垃圾云服务直播音频信息更新接口  */
            String apiUrl = "http://as.dun.163.com/v1/liveaudio/feedback";
            ...
            if(result != null)
            {
                ...
                if (code == 200)
                {
                    ...
                    foreach (var item in resultArray) {
                        ...
                        int status = resultObject["result"].ToObject<Int32>();
                        if (status == 0) {
