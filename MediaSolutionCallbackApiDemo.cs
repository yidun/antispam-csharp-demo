...
{
    class MediaSolutionCallbackApiDemo
    {
        public static void mediaSolutionCallBack()
        {
            /** 产品密钥ID，产品标识 */
            ...
            String apiUrl = "http://as.dun.163.com/v1/mediasolution/callback/results";
            ...
            if(resultResponse != null)
            {
                ...
                if (code == 200)
                {
                    ...
                    foreach (var item in array)
                    {
                        ...
                        // 检测结果
                        int checkStatus = tmp.GetValue("checkStatus").ToObject<Int32>();
                        Console.WriteLine(String.Format("融媒体解决方案结果：taskId={0}：dataId={1}：result={2}：callback={3}", taskId, dataId, result, callback));
                    }
                }
                else
                {
